...
namespace Library20.Controllers
{
    public class LibrariesController : Controller
    {
        ...
        public LibrariesController(Library20Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("LibraryId,LibraryName")] Library library)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LibraryId,LibraryName")] Library library)
        {
